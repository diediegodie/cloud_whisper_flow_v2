...
class Translator:
    ...
    def translate(self, text: str, target_language: str = "English", source_language: str = "pt") -> str:
        ...
        for engine in self.ENGINES:
            try:
                ...
                result = ts.translate_text(query_text=text, translator=engine, from_language=source_language, to_language=target_code, timeout=10)
